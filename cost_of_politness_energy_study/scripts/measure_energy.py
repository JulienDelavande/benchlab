...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_csv", type=str, default="../data/Llama-3.1-8B-Instruct-ultrachat_200k-Llama-3-8B-Instruct-with-thanks-energy.csv", help="Path to the output CSV file for energy measurements")
    parser.add_argument("--out_generated", type=str, default="../data/Llama-3.1-8B-Instruct-ultrachat_200k-Llama-3-8B-Instruct-with-thanks-generated.csv", help="Path to the output CSV file for generated samples")
